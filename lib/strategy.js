// Load modules.
var OAuth2Strategy = require('@joewitt99/passport-dynamicoauth2')
  , util = require('util')
  , uri = require('url')
  , GooglePlusProfile = require('./profile/googleplus')
  , OpenIDProfile = require('./profile/openid')
  , InternalOAuthError = require('@joewitt99/passport-dynamicoauth2').InternalOAuthError
 ...
 * @access protected
 */
Strategy.prototype.userProfile = function(accessToken, oauth2, done) {
  var self = this;
